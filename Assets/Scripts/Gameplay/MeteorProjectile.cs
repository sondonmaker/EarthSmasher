...
public class MeteorProjectile : MonoBehaviour
{
    ...
    public void Launch(EarthPlanet earth, Vector3 impactPoint, Vector3 impactNormal, float? overrideDamage = null)
    {
        ...
        ProFxParticleSpawner.AttachMeteorBody(transform, false, earth.Radius);
    }
    ...
    void Update()
    {
        ...
        transform.Rotate(Vector3.right, 60f * Time.deltaTime, Space.Self);
    ...
    void Impact()
    {
        ...
        PopulationCasualtySystem.ApplyAt(
            _earth,
            _impactPoint,
            PopulationCasualtySystem.DigNormToDegrees(0.52f),
            Mathf.Clamp01(0.25f + damage * 0.048f),
            1.05f);
    ...
    void SpawnImpactFx()
    {
        ...
        bool usedPack = ProFxParticleSpawner.TryMeteorImpact(_impactPoint, _impactNormal, earthSize, damage);
